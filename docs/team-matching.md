...
See **[Docker Setup → Volume Mounts](docker.html#custom-team-and-league-overrides)** for how to mount custom team files. Both single-file (`teams.json`) and directory-based mounts are supported.

...
| `iconurl` | string | - | **League Cover:** Optional image URL to display on the league cover for sports that are not based on matchups (motorsports, etc.). Requires `ALLOW_EVENT_OVERLAYS=true`. |
